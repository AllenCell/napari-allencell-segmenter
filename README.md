...
### Optino 1 (recommended):

After you installed the lastest version of Napari, you can go to "Plugins" --> "Install/Uninstall Package(s)". Then, you will be able to see all available Napari plugins and you can find us by name "napari-aicssegmentation". Just click the "install" button to install the Segmenter plugin.

### Option 2:

You can also install `napari-aicssegmentation` via [pip]:
...
2. Start the plugin (open napari, go to "Plugins" --> "Add Dock Widget" --> "napari-aicssegmentation" --> "workflow editor")
...
8. Save the workflow
9. Close the plugin and open the **batch processing** part by (go to "Plugins" --> "Add Dock Widget" --> "napari-aicssegmentation" --> "batch processing")
